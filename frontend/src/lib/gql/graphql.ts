...
export type PokemonsQuery = { __typename?: 'Query', pokemons: { __typename?: 'PokemonConnection', count: number, edges: Array<{ __typename?: 'Pokemon', id: string, image: string, name: string, types: Array<string>, isFavorite: boolean }> } };
